...
```{r scene 1-1}
fit_obj_1 <- stan_glm(data = week_8, 
                      formula = att_chg ~ gender -1, 
                      refresh = 0)

print(fit_obj_1, detail = FALSE) 
```
...
```{r}
fit_obj_2 <- stan_glm(data = week_8, 
                      formula = att_chg ~ liberal -1, 
                      refresh = 0)

print(fit_obj_2, detail = FALSE) 
```

* `att_chg` as a function of `treatment`

```{r}
fit_obj_3 <- stan_glm(data = week_8, 
                      formula = att_chg ~ treatment -1, 
                      refresh = 0)

print(fit_obj_3, detail = FALSE, digits = 4) 
```
